...
Метод выводит количества публикаций на каждую дату переданного в параметре ```year``` года или текущего года, если параметр ```year``` не задан или ошибочен.
...
```json
{
	...
	"Дизлайков": 320,
	"Просмотров": 700,
	"Первая публикация": "2012-07-16 17:35"
}
```
